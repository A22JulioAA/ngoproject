 ...
 */
final class Version20240228094044 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE offer (id INT AUTO_INCREMENT NOT NULL, id_organization_id INT NOT NULL, title VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, init_date DATE DEFAULT NULL, finish_date DATE DEFAULT NULL, vacancy INT DEFAULT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', last_update DATETIME NOT NULL, INDEX IDX_29D6873EDB966056 (id_organization_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
